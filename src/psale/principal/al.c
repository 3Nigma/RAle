...
gboolean al_este_placuta_conectata() {
...
gboolean al_scrie_aplicatie(const gchar *caleFisHex) {
...
void al_citeste_eeprom(GtkListStore *lm) {
    gchar *cDir = g_get_current_dir();
    gchar com[255];
...
void al_scrie_eeprom(GtkListStore *lm) {
